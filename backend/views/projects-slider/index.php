...
/** @var common\models\ProjectsSliderSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Слайдер - проекты';
...
//                'id',
                ...
                [
                    'attribute' => 'image',
                    'value' => function($data) {
                        $image = \common\components\StaticFunctions::getImage($data->image, 'projects-slider', $data->id);
