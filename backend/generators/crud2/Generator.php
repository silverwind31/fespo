...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateActiveField($attribute)
    {
        ...
        if (preg_match('/^(image|images)$/i', $attribute)) {
            return "<img class=\"image_preview postImage\" data-title=\"<?= \$model->title ?>\" data-img=\"<?= Yii::\$app->params['frontend'] . Yii::\$app->params['uploads_url'] . Yii::\$app->controller->id . '/' . \$model->id . '/l_' . \$model->" . $attribute . " ?>\"src=\"<?= Yii::\$app->params['frontend'] . Yii::\$app->params['uploads_url'] . Yii::\$app->controller->id . '/' . \$model->id . '/m_' . \$model->" . $attribute . " ?>\"/>";
        }
