<section class="promo">
    <div class="promoslider">
        <?php if(!empty($projectsSlides)): ?>
            <?php foreach ($projectsSlides as $slide): ?>
                <?php $image = \common\components\StaticFunctions::getImage($slide->image, 'projects-slider', $slide->id) ?>
